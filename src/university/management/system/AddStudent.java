...
class AddStudent implements ActionListener{
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"Computer Science","Electronics","Electrical","Mechanical","Civil","Digital marketing","chemistry","Information Technology","Human Resources","Arts","Political science"};
